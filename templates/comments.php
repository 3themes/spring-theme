      ...
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <?php else : ?>
          <div class="comments--form-row form-row">
            <label for="commentsAuthor"><?php _e('Name', 'spring'); if ($req) _e(' (required)', 'spring'); ?></label>
            <input type="text" placeholder="Your name..." class="textbox" name="author" id="commentsAuthor" value="<?php echo esc_attr($comment_author); ?>" size="22" <?php if ($req) echo 'aria-required="true"'; ?>>
          </div>
          <div class="comments--form-row form-row">
            <label for="commentsEmail"><?php _e('Email (will not be published)', 'spring'); if ($req) _e(' (required)', 'spring'); ?></label>
            <input type="email" placeholder="Your email address..." class="textbox" name="email" id="commentsEmail" value="<?php echo esc_attr($comment_author_email); ?>" size="22" <?php if ($req) echo 'aria-required="true"'; ?>>
          </div>
          <div class="comments--form-row form-row">
        ...
        <div class="button-wrapper">
            <input name="submit" class="button" type="submit" id="submit" value="<?php _e('Submit Comment', 'spring'); ?>">
        </div>
